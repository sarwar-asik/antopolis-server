...
const create_animal = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.file) {
        ...
        if (uploadResult) {
            profileImageUrl =
                (_a = uploadResult === null || uploadResult === void 0 ? void 0 : uploadResult.secure_url) !== null && _a !== void 0 ? _a : 'https://res.cloudinary.com/dwaiudyzc/image/upload/v1720951130/rcaye4nngpgnkfno3bc5.png';
        }
    }
    if (profileImageUrl) {
